...
bool PauseState::onEnter()
{
	...
	GameObject* button1 = new MenuButton(new LoaderParams(540, 200, 200, 80, "mainbutton"), s_pauseToMain);
	GameObject* button2 = new MenuButton(new LoaderParams(540, 400, 200, 80, "resumebutton"), s_resumePlay);
